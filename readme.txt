...
BP Labs contains three unofficial BuddyPress experiments; *@mentions autosuggest*, *Quick Admin*, and *Activity Akismet*. All experiments are in beta, and come with no guarantees.
...
*Activity Akismet* keeps your Activity Stream minty-fresh by integrating it with Automattic's Akismet spam filtering service, It requires the Akismet WordPress plugin to work.
...
* Added Activity Akismet experiment.
